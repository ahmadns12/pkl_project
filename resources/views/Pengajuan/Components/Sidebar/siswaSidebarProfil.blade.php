    ...
    <div class="sidebar min-h-screen w-[3.35rem] overflow-hidden border-r hover:w-56 hover:bg-white hover:shadow-lg fixed">
        <div class="flex h-screen flex-col justify-between pt-2 pb-6">
            ...
            <ul class="mt-2 space-y-2 tracking-wide">
                <li class="min-w-max">
                    <a href="/siswa/pengajuan" class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600">
                        <i class="fa-solid fa-bars text-center pt-[0.05rem] pl-[0.15rem] h-5 w-5 text-gray-600 group-hover:text-cyan-600"></i>
            ...
            <div class="w-full -mb-3">
                <a href="/siswa/pengajuan" aria-label="dashboard" class="w-full relative flex items-center space-x-4 bg-gradient-to-r from-sky-600 to-cyan-400 px-4 py-3 text-white">
                    <i class="fa-solid fa-circle-user w-5 h-5 text-center pt-[0.1rem] pl-[0.25rem]"></i>
                    <span class="-mr-1 font-medium font-poppins ">User</span>
                </a>
