...
<head>
    ...
    <title>Tambah Akun Pembimbing</title>
...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 mt-14">
            <div class="p-2">
                <h2 class="text-lg font-poppins font-bold"><span>Tambah Akun Pembimbing</span></h2>
                <h2 class="text-md font-poppins"><span>Tambah akun pembimbing sesuai dengan data pembimbing yang sudah disiapkan.</span></h2>
            </div>
            <div class="flex">
                <a href="{{ url()->previous() }}">
            ...
            @if(Auth::user()->role=='kakom')
            <form action="/admin/kakom/akunpembimbing/store" method="POST" enctype="multipart/form-data">
            @endif
            @if(Auth::user()->role=='superadmin')
            <form action="/admin/superadmin/akunpembimbing/store" method="POST" enctype="multipart/form-data">
            @endif
                @csrf
                <input type="hidden" name="id">
                <div class="relative flex flex-col shadow-lg mb-6 rounded-lg p-4">
                    <div class="block bg-transparent w-full overflow-x-auto">
                        <span class="font-poppins font-semibold">Akun Pembimbing</span>
                            ...
                            <div class="ml-2 mt-1 w-1/2">
                                <div class="w-full flex border-solid border rounded-lg mt-2">
                                    ...
                                    <div class="w-8/12 rounded-l-lg">
                                        <input class="p-2 h-full w-full outline-none font-poppins" type="text" name="angkatan">
                                    </div>
                                </div>
                                <div class="w-full flex border-solid border rounded-lg mt-2">
                                    <div class="w-4/12 bg-gray-200 p-2 rounded-l-lg">
                                        <span class="text-md font-poppins font-semibold text-black">Pilih Guru</span>
                                    </div>
