...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 mt-14">
            <div class="p-2">
                <h2 class="text-lg font-poppins font-bold"><span>Tambah Panduan</span></h2>
                <h2 class="text-md font-poppins"><span>Tambah panduan sesuai dengan data yang sudah disiapkan.</span></h2>
            </div>
            <div class="flex">
                <a href="{{ url()->previous() }}">
            ...
            @if(Auth::user()->role=='hubin')
            <form action="/admin/hubin/panduan/store" method="POST" enctype="multipart/form-data">
            @endif
            @if(Auth::user()->role=='kakom')
            <form action="/admin/kakom/panduan/store" method="POST" enctype="multipart/form-data">
            @endif
            @if(Auth::user()->role=='superadmin')
            <form action="/admin/superadmin/panduan/store" method="POST" enctype="multipart/form-data">
            @endif
                @csrf
                            ...
                            <div class="mt-1 w-1/2">
                                ...
                                <div class="w-full flex border-solid border rounded-lg mt-2">
                                    ...
                                    <div class="w-8/12 p-2 rounded-l-lg">
                                        <input class="h-full w-full outline-none font-poppins" type="text" name="nama_panduan">
                                    </div>
                                </div>
                                @if ($errors->any())
                            ...
                            <div class="ml-2 mt-1 w-1/2">
                                <div class="w-full flex flex-col rounded-lg border border-solid">
                                    ...
                                    <div class="w-full rounded-b-lg h-24 p-2">
                                        <textarea class="w-full outline-none font-poppins" name="deskripsi" cols="30" rows="3"></textarea>
                                    </div>
                                </div> 
                            </div>
                        </div>
