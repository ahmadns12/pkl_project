...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 mt-14">
            <div class="p-2">
                <h2 class="text-lg font-poppins font-bold"><span>Edit Akun Hubin</span></h2>
                <h2 class="text-md font-poppins"><span>Edit akun hubin sesuai dengan data yang sudah dimasukkan sebelumnya.</span></h2>
            </div>
            <div class="flex">
                <a href="{{ url()->previous() }}">
            ...
            @if(Auth::user()->role=='superadmin')
            <form action="/admin/superadmin/akunhubin/update/{{$akunhubin->id}}" method="POST">
            @endif
                @csrf
                {{method_field('PUT')}}
                <input type="hidden" name="id" value="{{$akunhubin->id}}">
                            ...
                            <div class="mt-3 w-1/2">
                                <div class="w-full flex border-solid border rounded-lg">
                                    ...
                                    <div class="w-8/12 p-2 rounded-l-lg">
                                        <input class="h-full w-full outline-none font-poppins" type="text" name="email" value="{{$akunhubin->email}}">
                                    </div>
                                </div>
