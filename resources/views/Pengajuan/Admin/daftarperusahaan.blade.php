...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 mt-14">
            <div class="p-2">
                <h2 class="text-lg font-poppins font-bold"><span>Daftar Perusahaan</span></h2>
                <h2 class="text-md font-poppins"><span>Perusahaan-perusahaan yang terdaftar saat ini.</span></h2>
                @if (session('store'))
            ...
            <div class="relative flex flex-col shadow-lg mb-6 rounded-lg p-4">
                {{-- Search --}}
                <div class="p-2 mb-2">
                    <label for="search" class="font-poppins font-semibold text-gray-500">Cari Perusahaan:</label>
                    <input type="text" id="search" class="w-full p-2 border border-gray-300 border-solid rounded-lg outline-none font-poppins" placeholder="Nama perusahaan...">
                </div>
                {{-- Search-end --}}
                <div class="flex flex-wrap mb-2 container-perusahaan">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            searchInput.addEventListener("input", function () {
                ...
                $.ajax({
                    url: '/admin/cari-perusahaan',
                    type: 'GET',
                    data: { search: searchTerm },
                    success: function (data) {
                        document.querySelector('.container-perusahaan').innerHTML = data;
                    }
                });
            });
        });
