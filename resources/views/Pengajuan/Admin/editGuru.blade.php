...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 mt-14">
            <div class="p-2">
                <h2 class="text-lg font-poppins font-bold"><span>Edit Guru</span></h2>
                <h2 class="text-md font-poppins"><span>Edit guru sesuai dengan data yang sudah disiapkan.</span></h2>
            </div>
            <div class="flex">
                <a href="{{ url()->previous() }}">
            ...
            @if(Auth::user()->role=='hubin')
            <form action="/admin/hubin/daftarguru/update/{{$guru->id_guru}}" method="POST" enctype="multipart/form-data">
            @endif
            @if(Auth::user()->role=='kakom')
            <form action="/admin/kakom/daftarguru/update/{{$guru->id_guru}}" method="POST" enctype="multipart/form-data">
            @endif
            @if(Auth::user()->role=='superadmin')
            <form action="/admin/superadmin/daftarguru/update/{{$guru->id_guru}}" method="POST" enctype="multipart/form-data">
            @endif
                @csrf
                {{method_field('PUT')}}
                            ...
                            <div class="mt-3 w-1/2">
                                <div class="w-full flex flex-col rounded-lg border border-solid">
                                    ...
                                    <div class="w-full rounded-b-lg h-64 p-2">
                                        <input type="file" name="image" onchange="loadFile(event)" value="{{asset('img/guru/'. $guru->gambar_guru)}}">
                            ...
                            <div class="ml-2 mt-1 w-1/2">
                                <div class="w-full flex border-solid border rounded-lg mt-2">
                                    ...
                                    <div class="w-8/12 p-2 rounded-l-lg">
                                        <input class="h-full w-full outline-none font-poppins" type="text" name="nip"  value="{{$guru->nip}}">
                                    </div>
                                </div>
                                <div class="w-full flex border-solid border rounded-lg mt-2">
                                    <div class="w-4/12 bg-gray-200 p-2 rounded-l-lg">
                                    ...
                                    <div class="w-8/12 p-2 rounded-l-lg">
                                        <input class="h-full w-full outline-none font-poppins" type="text" name="nik" value="{{$guru->nik}}">
                                    </div> 
                                </div>
                                <div class="w-full flex border-solid border rounded-lg mt-2">
                                    <div class="w-4/12 bg-gray-200 p-2 rounded-l-lg">
                                    ...
                                    <div class="w-8/12 p-2 rounded-l-lg">
                                        <input class="h-full w-full outline-none font-poppins" type="text" name="nama_guru" value="{{$guru->nama_guru}}">
                                    </div>
                                </div>
                                <div class="w-full flex border-solid border rounded-lg mt-2">
                                    <div class="w-4/12 bg-gray-200 p-2 rounded-l-lg">
                                ...
                                <div class="w-full flex border-solid border rounded-lg mt-2">
                                    ...
                                    <div class="w-8/12 p-2 rounded-l-lg">
                                        <input class="h-full w-full outline-none font-poppins" type="text" name="jabatan" value="{{$guru->jabatan}}">
                                    </div>
                                </div>
                            </div>
                        </div>
