                        ...
                        <div class="flex w-full">
                                ...
                                <div class="w-full flex border-solid border rounded-lg mt-2">
                                    ...
                                    <select class="p-2 h-full w-full outline-none font-poppins" name="id_guru">
                                        @foreach ($guru as $item)
                                            <option value="{{$item->id_guru}}" {{ $item->id_guru == $siswa->id_guru ? 'selected' : '' }}>
                                                {{ ucfirst($item->nama_guru) }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>                                  
                            ...
                            <div class="ml-2 mt-1 w-1/2">
                                ...
                                <div class="w-full flex border-solid border rounded-lg mt-2">
                                    ...
                                    <div class="w-8/12 p-2 rounded-l-lg">
                                        <input class="h-full w-full outline-none font-poppins" type="text" name="jurusan" value="{{$siswa->jurusan}}">
                                    </div>
                                </div>
                                <div class="w-full flex border-solid border rounded-lg mt-2">
                                    <div class="w-4/12 bg-gray-200 p-2 rounded-l-lg">
                                    ...
                                    <div class="w-8/12 p-2 rounded-l-lg">
                                        <input class="h-full w-full outline-none font-poppins" type="text" name="angkatan" value="{{$siswa->angkatan}}">
                                    </div>
                                </div>
                            </div>
                        </div>
