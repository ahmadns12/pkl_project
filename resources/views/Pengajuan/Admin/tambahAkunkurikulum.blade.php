...
<head>
    ...
    <title>Tambah Akun Kurikulum</title>
...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 mt-14">
            ...
            @if(Auth::user()->role=='superadmin')
            <form action="/admin/superadmin/akunkurikulum/store" method="POST" enctype="multipart/form-data">
            @endif
                @csrf
                            ...
                            <div class="ml-2 mt-1 w-1/2">
                                <div class="w-full flex border-solid border rounded-lg mt-2">
                                    ...
                                    <div class="w-8/12 rounded-l-lg">
                                        <input class="p-2 h-full w-full outline-none font-poppins" type="text" name="nama_kurikulum" placeholder="Nama pihak kurikulum...">
                                    </div>
                                </div>
                            </div>
                        </div>
