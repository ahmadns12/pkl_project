...
<head>
    ...
    <title>Angkatan | Tahun Pembelajaran</title>
...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 mt-14">
            <div class="p-2">
                <h2 class="text-lg font-poppins font-bold"><span>Angkatan dan Tahun Pembelajaran</span></h2>
                <h2 class="text-md font-poppins"><span>Daftar angkatan dan tahun pembelajaran yang terdaftar saat ini.</span></h2>
                @if (session('store'))
            ...
            <div class="relative flex flex-col shadow-lg mb-6 rounded-lg p-4">
                {{-- Search --}}
                <div class="p-2 mb-2">
                    <label for="search" class="font-poppins font-semibold text-gray-500">Cari Angkatan:</label>
                    <input type="text" id="search" class="w-full p-2 border border-gray-300 border-solid rounded-lg outline-none font-poppins" placeholder="Angkatan...">
                </div>
                {{-- Search-end --}}
                <div class="flex flex-wrap mb-2 container-angkatan">
                ...
                {{ $dataangkatan->links('pagination::tailwind') }}
            </div>
            ...
            <div class="flex">
                <div class="w-3/12 relative flex flex-col shadow-lg rounded-lg p-4 mr-4">
                    ...
                    <span class="font-poppins font-bold text-[#8AA7FF] text-2xl p-2 text-center">{{$totalangkatan}}</span>
                </div>

                <div class="w-2/12 relative flex flex-col shadow-lg rounded-lg p-4 mr-4 hover:bg-[#8AA7FF] transition ease-linear font-poppins font-semibold text-gray-500 hover:text-white text-center"  onclick="window.location='{{ route('tambahAngkatan') }}'">
                    Tambah
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            searchInput.addEventListener("input", function () {
                ...
                $.ajax({
                    url: '/admin/cari-angkatan',
                    type: 'GET',
                    data: { search: searchTerm },
                    success: function (data) {
                        document.querySelector('.container-angkatan').innerHTML = data;
                    }
                });
            });
        });
