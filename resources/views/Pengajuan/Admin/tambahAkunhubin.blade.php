...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 mt-14">
            <div class="p-2">
                <h2 class="text-lg font-poppins font-bold"><span>Tambah Akun Hubin</span></h2>
                <h2 class="text-md font-poppins"><span>Tambah akun hubin sesuai dengan data hubin yang sudah disiapkan.</span></h2>
            </div>
            <div class="flex">
                <a href="{{ url()->previous() }}">
            ...
            @if(Auth::user()->role=='superadmin')
            <form action="/admin/superadmin/akunhubin/store" method="POST" enctype="multipart/form-data">
            @endif
                @csrf
                <input type="hidden" name="id">
                <div class="relative flex flex-col shadow-lg mb-6 rounded-lg p-4">
                    <div class="block bg-transparent w-full overflow-x-auto">
                        <span class="font-poppins font-semibold">Akun Hubin (Hubungan Industri)</span>
