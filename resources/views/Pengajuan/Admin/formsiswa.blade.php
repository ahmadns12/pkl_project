        ...
        <div class="p-4 sm:ml-64">
            <div class="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 mt-14">
                ...
                <div class="flex">
                    ...
                    <div class="w-3/12 relative flex flex-col shadow-lg mb-6 rounded-lg p-4 mr-4">
                        <span class="font-poppins font-semibold text-gray-500">Belum di Approve</span>
                        <span class="font-poppins font-bold text-[#8AA7FF] text-2xl p-2 text-center">{{ $belumDiApproveHubin }}</span>
                    </div>
                    
                    <div class="w-3/12 relative flex flex-col shadow-lg mb-6 rounded-lg p-4">
                        <span class="font-poppins font-semibold text-gray-500">Sudah di Approve</span>
                        <span class="font-poppins font-bold text-[#8AA7FF] text-2xl p-2 text-center">{{ $sudahDiApproveHubin }}</span>
                    </div>
                    @endif
                    {{-- Hubin-END --}}
                    ...
                    <div class="w-3/12 relative flex flex-col shadow-lg mb-6 rounded-lg p-4 mr-4">
                        <span class="font-poppins font-semibold text-gray-500">Belum di Approve</span>
                        <span class="font-poppins font-bold text-[#8AA7FF] text-2xl p-2 text-center">{{$belumDiApproveKurikulum}}</span>
                    </div>
                    
                    <div class="w-3/12 relative flex flex-col shadow-lg mb-6 rounded-lg p-4">
                        <span class="font-poppins font-semibold text-gray-500">Sudah di Approve</span>
                        <span class="font-poppins font-bold text-[#8AA7FF] text-2xl p-2 text-center">{{$sudahDiApproveKurikulum}}</span>
                    </div>
                    @endif
                    {{-- Kurikulum-END --}}
                </div>
