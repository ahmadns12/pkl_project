    ...
    {{-- Content-end --}}
        <div class="p-4 sm:ml-64">
            <div class="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 mt-14">
                <div class="p-2">
                    <h2 class="text-lg font-poppins font-bold"><span>Akun Siswa</span></h2>
                    <h2 class="text-md font-poppins"><span>Akun-akun siswa yang terdaftar di aplikasi PKL ini.</span></h2>
                    @if (session('success'))
                ...
                <div class="relative flex flex-col shadow-lg mb-6 rounded-lg p-4">
                    {{-- Search --}}
                    <div class="p-2 mb-2">
                        <label for="search" class="font-poppins font-semibold text-gray-500">Cari Akun siswa:</label>
                        ...
                        <table class="w-full mt-2">
                            <thead>
                                <tr class="border border-solid border-l-0 border-r-0">
                                    ...
                                    <th class="text-md px-6 py-3 font-poppins">Status</th>
                            ...
                            <tbody class="container-akunsiswa">
                                ...
                                <tr class="border border-solid rounded-lg text-center">
                                    ...
                                    <td class="text-md px-6 py-3 font-poppins">
                                        @if(Auth::user()->role=='hubin')
                                        <a href="/admin/hubin/akunsiswa/edit/{{$item->id_siswa}}">
                                        @endif
                                        @if(Auth::user()->role=='kakom')
