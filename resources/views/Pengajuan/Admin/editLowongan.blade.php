...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 mt-14">
            <div class="p-2">
                <h2 class="text-lg font-poppins font-bold"><span>Edit Lowongan</span></h2>
                <h2 class="text-md font-poppins"><span>Edit lowongan sesuai dengan data yang sudah dimasukkan sebelumnya.</span></h2>
            </div>
            <div class="flex">
                <a href="{{ url()->previous() }}">
            ...
            @if(Auth::user()->role=='kakom')
            <form action="/admin/kakom/lowongan/update/{{$lowongan->id_lowongan}}" method="POST">
            @endif
                @csrf
                {{method_field('PUT')}}
                ...
                <div class="relative flex flex-col shadow-lg mb-6 rounded-lg p-4">
                    <div class="block bg-transparent w-full overflow-x-auto">
                        <span class="font-poppins font-semibold">Edit Lowongan</span>
                        <div class="flex w-full">
                            <div class="mt-3 w-1/2">
                                <div class="w-full flex border-solid border rounded-lg">
                                    ...
                                    <div class="w-8/12 p-2 rounded-l-lg">
                                        <input class="h-full w-full outline-none font-poppins" type="text" name="id_perusahaan" value="{{ $lowongan->perusahaan->nama_perusahaan }}" disabled>
                                        <input type="hidden" name="id_perusahaan" value="{{ $lowongan->perusahaan->id_perusahaan }}">
                                    </div>
                                </div>
                                <div class="w-full flex border-solid border rounded-lg mt-2">
                                    ...
                                    <div class="w-8/12 p-2 rounded-l-lg">
                                        <input class="h-full w-full outline-none font-poppins" type="number" name="jumlah_siswa" value="{{$lowongan->jumlah_siswa}}">
                                    </div>
                                </div>
                                <div class="w-full flex border-solid border rounded-lg mt-2">
                                    <div class="w-4/12 bg-gray-200 p-2 rounded-l-lg">
                                    ...
                                    <div class="w-8/12 p-2 rounded-l-lg">
                                        <input class="h-full w-full outline-none font-poppins" type="text" name="posisi" value="{{$lowongan->posisi}}">
                                    </div>
                                </div>
                            </div>
                            <div class="ml-2 mt-1 w-1/2">
                                <div class="w-full flex border-solid border rounded-lg mt-2">
                                    ...
                                    <div class="w-8/12 p-2 rounded-l-lg">
                                        <input class="h-full w-full outline-none font-poppins" type="date" name="tanggal_mulai" value="{{$lowongan->tanggal_mulai}}">
                                    </div>
                                </div>
                                <div class="w-full flex border-solid border rounded-lg mt-2">
                                    <div class="w-4/12 bg-gray-200 p-2 rounded-l-lg">
                                    ...
                                    <div class="w-8/12 p-2 rounded-l-lg">
                                        <input class="h-full w-full outline-none font-poppins" type="date" name="tanggal_selesai" value="{{$lowongan->tanggal_selesai}}">
                                    </div>
                                </div>
                                <div class="w-full flex border-solid border rounded-lg mt-2">
                                    <div class="w-4/12 bg-gray-200 p-2 rounded-l-lg">
                                    ...
                                    <div class="w-8/12 p-1 rounded-l-lg">
                                        <select class="h-full w-full outline-none font-poppins" name="id_angkatan">
                                            ...
                                            @foreach ($angkatan as $item)
                                                @if ($item->id_angkatan == $lowongan->angkatan->id_angkatan)
                                                    <option value="{{$item->id_angkatan}}" selected>{{$item->angkatan}}</option>
                                                @else
                                                    <option value="{{$item->id_angkatan}}">{{$item->angkatan}}</option>
                                                @endif
                                            @endforeach
                                        </select>
                                    </div>
